...
class ContactAdapter(private var listContact: List<Contact>, private val onClickContact: OnClickContact) : RecyclerView.Adapter<ContactAdapter.ItemContactViewHolder>() {
